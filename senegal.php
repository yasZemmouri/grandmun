...
<head>
    <title>Grandmun - Senegal Project</title>
    <!--===== Meta =====-->
    <meta charset="utf-8">
    ...
    <!--===== Favicons =====-->
    <link rel="icon" type="image/x-icon" href="assets/img/favicon-32.ico">
    ...
    <main id="senegal">
        <div class="banner" style="background-image: url(assets/img/boots_ski_large_sport_25.jpg);">
            <div class="container-xl">
                <h1>Senegal Project</h1>
            </div>
        </div>
        <section id='senegal-vid'>
            <div class='container-xl'>
                <h2>Join GRANDMUN in Supporting the Building of a Library in Senegal</h2>
